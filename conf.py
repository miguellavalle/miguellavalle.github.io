...
BLOG_AUTHOR = "Miguel Lavalle"  # (translatable)
BLOG_TITLE = "code bits and other stuff by Miguel Lavalle"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.miguellavalle.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.miguellavalle.com/"
BLOG_EMAIL = "miguel@mlavalle.com"
BLOG_DESCRIPTION = "Code bits sprinkled with other stuff"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "miguellavalle"
